...
def summarize_results(scores, filters, epochs, batch_size):
	...
	pyplot.title('Accuracy para Epoch=%d, Batch_size=%d, Filtros capa CNN1D=%d, Kernel=8' % (epochs, batch_size, filters[i]))
...
# run an experiment
def run_experiment(filters, epochs, batch_size, repeats=16):
	# load data
